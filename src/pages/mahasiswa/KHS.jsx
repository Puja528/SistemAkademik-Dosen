...
export default function KHS() {
  ...
  // Perhitungan IPS Dinamis untuk semester terpilih
  ...
  // Fungsi utilitas penentu warna lencana grade (Gaya institusi yang lembut & rapi)
    ...
    <main className="p-6 bg-[#f4f6f9] min-h-screen font-sans text-xs text-slate-700 w-full flex flex-col gap-6">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">IPK Kumulatif (Profil)</p>
          <p className="text-xl font-black text-[#1a3a6b] tracking-tight mt-1">{dataAkademik.profil?.ipk || "0.00"}</p>
        </div>
        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
